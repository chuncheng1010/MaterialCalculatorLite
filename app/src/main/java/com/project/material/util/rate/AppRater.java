package com.project.material.util.rate;
...
public class AppRater {
    ...
    public static void gotoProVersion(Context context) {
        try {
        	context.startActivity(new Intent(Intent.ACTION_VIEW,
                    Uri.parse("market://details?id=com.apps4builders.MaterialWeightCalcuatorPRO")));
        } catch (Exception e) {
        	context.startActivity(new Intent(Intent.ACTION_VIEW,
                    Uri.parse("http://play.google.com/store/apps/details?id=com.apps4builders.MaterialWeightCalcuatorPRO")));
        }
    }
